...
import edu.cmu.cc.slh.view.validator.textview.MembershipValidator;
...
public class ActivationViewAdapter {
	...
	public ActivationViewAdapter(View view) {
	 ...
	 * @return string value
	 */
	public static String getMembershipID(View view) {
		
		String membershipID = WidgetUtils.getEditTextAsString(view, 
