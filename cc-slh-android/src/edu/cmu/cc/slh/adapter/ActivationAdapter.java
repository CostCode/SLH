...
public class ActivationAdapter {
	...
	public static synchronized boolean persistActivationStatus(
			ApplicationState appState, boolean status) {
		
		return saveToSharedPrefs(appState, KEY_ACTIVATION_STATUS, 
	...
	public static boolean retrieveActivationStatus(
		...
		return retrieveFromSharedPrefs(appState, KEY_ACTIVATION_STATUS);
	}
	...
	private static boolean saveToSharedPrefs(Context ctx, 
		...
		try {
			...
			String errorMsg = getActivationErrorMessage(
					ctx, R.string.activation_error_status_persist, t);
			
			Logger.logErrorAndAlert(ctx, ActivationAdapter.class, errorMsg, t);
		}
	...
	private static String getActivationErrorMessage(Context ctx, 
