...
/**
 *  DESCRIPTION: Shopping list item dialog. This dialog enables the user to
 *  edit the existing item or create a new one.
 *	
				...
				if (dialog != null) {
					...
					btnNegative.setOnClickListener(new View.OnClickListener() {
						...
						public void onClick(View v) {
							...
							Logger.logDebug(SLItemDialog.class, "CANCEL BUTTON WAS PRESSED!!!!!!");
							
							ApplicationState.getInstance().setCurrentSLItem(null);
							dlg.dismiss();
						}
					});
